...
def saveImage(src: str, dst_path: str, filename: str) -> Optional[str]:
    """
    Copy an image file from the source path to the destination directory with the specified filename.
